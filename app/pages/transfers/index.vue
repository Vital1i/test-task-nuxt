<template>
  <div class="min-h-screen flex bg-surface dark:bg-slate-950">
    ...
    <main class="flex-1 flex flex-col">
      <header>
        <div class="border-b border-border/70 dark:border-slate-700 mx-4 md:mx-6 lg:mx-8 py-4">
          <div class="flex flex-col gap-3">
            <div class="flex items-center justify-between gap-4">
              <div class="flex items-center gap-8">
                <h1 class="text-2xl font-medium text-text-primary dark:text-slate-100 font-jakarta">
                  Money Transfers
                </h1>
      ...
      <section class="px-4 md:px-6 lg:px-8 py-6 space-y-12">
        <div>
          <h2 class="text-xl font-medium text-text-primary dark:text-slate-100 mb-6 font-jakarta">
            Account balance
          </h2>
